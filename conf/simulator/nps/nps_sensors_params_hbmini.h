...
#define NPS_ACCEL_SENSITIVITY_XX  ACCEL_BFP_OF_REAL( 1./1.94)
#define NPS_ACCEL_SENSITIVITY_YY  ACCEL_BFP_OF_REAL( 1./1.94)
#define NPS_ACCEL_SENSITIVITY_ZZ  ACCEL_BFP_OF_REAL( 1./1.99)

#define NPS_ACCEL_NEUTRAL_X       26510
#define NPS_ACCEL_NEUTRAL_Y       26380
#define NPS_ACCEL_NEUTRAL_Z       25836
/* m2s-4 */
...
/* 2^12/GYRO_X_SENS */
#define NPS_GYRO_SENSITIVITY_PP   RATE_BFP_OF_REAL( 1./5.79)
#define NPS_GYRO_SENSITIVITY_QQ   RATE_BFP_OF_REAL( 1./5.89)
#define NPS_GYRO_SENSITIVITY_RR   RATE_BFP_OF_REAL( 1./4.56)

#define NPS_GYRO_NEUTRAL_P        21489
#define NPS_GYRO_NEUTRAL_Q        21500
#define NPS_GYRO_NEUTRAL_R        21822
