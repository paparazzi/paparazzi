...
#define NPS_ACCEL_SENSITIVITY_XX      (1./IMU_ACCEL_X_SENS)
#else
#define NPS_ACCEL_SENSITIVITY_XX      1.
#endif
#ifdef IMU_ACCEL_Y_SENS
#define NPS_ACCEL_SENSITIVITY_YY      (1./IMU_ACCEL_Y_SENS)
#else
#define NPS_ACCEL_SENSITIVITY_YY      1.
#endif
#ifdef IMU_ACCEL_Z_SENS
#define NPS_ACCEL_SENSITIVITY_ZZ      (1./IMU_ACCEL_Z_SENS)
#else
#define NPS_ACCEL_SENSITIVITY_ZZ      1.
#endif
...
#define NPS_GYRO_SENSITIVITY_PP       (1./IMU_GYRO_P_SENS)
#else
#define NPS_GYRO_SENSITIVITY_PP       1.
#endif
#ifdef IMU_GYRO_Q_SENS
#define NPS_GYRO_SENSITIVITY_QQ       (1./IMU_GYRO_Q_SENS)
#else
#define NPS_GYRO_SENSITIVITY_QQ       1.
#endif
#ifdef IMU_GYRO_R_SENS
#define NPS_GYRO_SENSITIVITY_RR       (1./IMU_GYRO_R_SENS)
#else
#define NPS_GYRO_SENSITIVITY_RR       1.
#endif
...
#define NPS_MAG_SENSITIVITY_XX      (1./IMU_MAG_X_SENS)
#else
#define NPS_MAG_SENSITIVITY_XX      1.
#endif
#ifdef IMU_MAG_Y_SENS
#define NPS_MAG_SENSITIVITY_YY      (1./IMU_MAG_Y_SENS)
#else
#define NPS_MAG_SENSITIVITY_YY      1.
#endif
#ifdef IMU_MAG_Z_SENS
#define NPS_MAG_SENSITIVITY_ZZ      (1./IMU_MAG_Z_SENS)
#else
#define NPS_MAG_SENSITIVITY_ZZ      1.
#endif
