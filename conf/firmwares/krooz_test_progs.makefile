...
#
#
#  Test program for the DIR 1.0 board
#
#
#
#
...
SRC_ARCH_HW=arch/$(ARCH)
SRC_DIR=krooz
SRC_DIR_ARCH=$(SRC_DIR)/arch/$(ARCH)
...
test_led.CFLAGS += -I$(SRC_DIR)
test_led.srcs   += $(SRC_DIR)/test_led.c
...
test_uart.CFLAGS += -I$(SRC_DIR) -DUSE_UART
...
test_uart.srcs += $(SRC_DIR)/test_uart_krooz.c
...
test_telemetry.CFLAGS += -I$(SRC_DIR)
...
test_baro.CFLAGS += -I$(SRC_DIR) -I$(SRC_BOARD)
...
test_adc.CFLAGS += -I$(SRC_DIR)
test_adc.srcs   += $(SRC_DIR)/test_adc.c
...
test_hmc5843.CFLAGS += -I$(SRC_DIR)
test_hmc5843.srcs   += krooz/test_hmc5843.c
