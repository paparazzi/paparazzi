...
# LEDs
#
ap.CFLAGS += -DUSE_LED# to get led.h properly compile
#ifeq ($(ARCH), chibios)
...
#
#FIXME TEMP HACK TO GET RADIO LED working
...
# nothing
#
#FIXME TEMP HACK TO GET LED working
ifneq ($(GPS_LED),none)
...
#
#temporary hack to get stuff done (eventually this will be replaced by imu/ahrs makefile
ap.CFLAGS += -DSTABILIZATION_ATTITUDE_TYPE_H=\"stabilization/stabilization_attitude_quat_int.h\"
#FIXME TEMP HACK TO GET AHRS LED working
