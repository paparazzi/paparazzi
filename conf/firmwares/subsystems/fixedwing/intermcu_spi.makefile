...
fbw.srcs    += $(SRC_FIXEDWING)/link_mcu_spi.c mcu_periph/spi_pprz.c $(SRC_ARCH)/mcu_periph/spi_arch.c
...
ap.srcs     += $(SRC_FIXEDWING)/link_mcu_spi.c mcu_periph/spi_pprz.c $(SRC_ARCH)/mcu_periph/spi_arch.c
SEPARATE_FBW    = 1
