...
IMU_PPZUAV_CFLAGS += -DIMU_TYPE_H=\"modules/sensors/imu_pololu.h\"

IMU_PPZUAV_SRCS    = $(SRC_SUBSYSTEMS)/imu.c             \
                      $(SRC_MODULES)/sensors/imu_pololu.c


IMU_PPZUAV_CFLAGS += -DUSE_I2C
ifeq ($(ARCH), stm32)
	IMU_PPZUAV_CFLAGS += -DUSE_I2C2
	IMU_PPZUAV_CFLAGS += -DPOLOLUIMU_I2C_DEVICE=i2c2
else ifeq ($(ARCH), lpc21)
	IMU_PPZUAV_CFLAGS += -DUSE_I2C0
	IMU_PPZUAV_CFLAGS += -DPOLOLUIMU_I2C_DEVICE=i2c0
endif
