...
ap.CFLAGS +=  -DDOWNLINK_TELEMETRY -DDOWNLINK_DATALINK -DDOWNLINK_CUSTOM -DDOWNLINK_FBW_DEVICE=$(MODEM_PORT) -DDOWNLINK_AP_DEVICE=$(MODEM_PORT) -DXBEE_UART=$(MODEM_PORT)
