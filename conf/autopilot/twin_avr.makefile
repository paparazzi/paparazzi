...
ap.srcs = gps_ubx.c gps.c main_ap.c $(SRC_ARCH)/modem_hw.c inter_mcu.c link_mcu.c $(SRC_ARCH)/link_mcu_ap.c $(SRC_ARCH)/spi_ap.c $(SRC_ARCH)/adc_ap.c infrared.c pid.c nav.c $(SRC_ARCH)/uart_ap.c estimator.c mainloop.c cam.c sys_time.c main.c
