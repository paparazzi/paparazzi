...
fbw.srcs +=  sys_time.c $(SRC_FIRMWARE)/main_fbw.c $(SRC_FIRMWARE)/main.c commands.c radio_control.c subsystems/datalink/pprz_transport.c subsystems/datalink/downlink.c  inter_mcu.c spi.c link_mcu.c
