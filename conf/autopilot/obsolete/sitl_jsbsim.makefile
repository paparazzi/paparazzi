...
jsbsim.srcs += latlong.c subsystems/datalink/downlink.c commands.c gps.c inter_mcu.c subsystems/sensors/infrared.c \
               $(SRC_FIXEDWING)/stabilization/stabilization_attitude.c \
               $(SRC_FIXEDWING)/guidance/guidance_v.c\
               subsystems/nav.c estimator.c mcu_periph/sys_time.c $(SRC_FIRMWARE)/main_fbw.c $(SRC_FIRMWARE)/main_ap.c $(SRC_FIRMWARE)/datalink.c
