...
#define MAVLINK_MSG_ID_BLOCK_ITEM_LEN 54
#define MAVLINK_MSG_ID_180_LEN 54

#define MAVLINK_MSG_ID_BLOCK_ITEM_CRC 42
#define MAVLINK_MSG_ID_180_CRC 42
...
#define MAVLINK_MESSAGE_INFO_BLOCK_ITEM { \
	...
	{  { "seq", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_block_item_t, seq) }, \
         ...
         { "name", NULL, MAVLINK_TYPE_CHAR, 50, 4, offsetof(mavlink_block_item_t, name) }, \
         } \
}
...
{
	return mavlink_msg_block_item_pack(system_id, component_id, msg, block_item->target_system, block_item->target_component, block_item->seq, block_item->name);
}
...
{
	return mavlink_msg_block_item_pack_chan(system_id, component_id, chan, msg, block_item->target_system, block_item->target_component, block_item->seq, block_item->name);
}
...
static inline void mavlink_msg_block_item_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq, const char *name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_BLOCK_ITEM_LEN];
	_mav_put_uint16_t(buf, 0, seq);
 ...
 */
static inline void mavlink_msg_block_item_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t seq, const char *name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
