...
let print_message_table = fun out_h xml ->
  ...
  List.iter (fun process ->
    let telem_type = Compat.string_uppercase (ExtXml.attrib_or_default process "type" "pprz") in
