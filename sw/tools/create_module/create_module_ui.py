...
class Ui_CreateModule_Window(object):
    def setupUi(self, CreateModule_Window):
        ...
        self.horizontalLayout_7.addWidget(self.init_button)
        self.periodic_button = QtWidgets.QPushButton(self.centralwidget)
        self.periodic_button.setObjectName("periodic_button")
        self.horizontalLayout_7.addWidget(self.periodic_button)
        self.event_button = QtWidgets.QPushButton(self.centralwidget)
        self.event_button.setObjectName("event_button")
        self.horizontalLayout_7.addWidget(self.event_button)
