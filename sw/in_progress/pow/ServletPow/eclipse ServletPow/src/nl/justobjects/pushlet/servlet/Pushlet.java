...
public class Pushlet extends HttpServlet implements Protocol {
	...
	public void init() throws ServletException {
		try {
			System.out.println("initiating pushlet servlet...");
			...
			System.out.println("pushlet initiates event sources...");
			if (Config.getBoolProperty(Config.SOURCES_ACTIVATE)) {
				EventSourceManager.start(webInfPath,getServletContext());// changed by thomas genin
			} else {
