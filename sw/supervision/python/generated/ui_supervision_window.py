...
class Ui_SupervisionWindow(object):
    def setupUi(self, SupervisionWindow):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.tools_panel)
        ...
        self.magviewer_widget = MagViewer(self.groupBox_2)
        self.magviewer_widget.setObjectName("magviewer_widget")
        self.verticalLayout_3.addWidget(self.magviewer_widget)
    ...
    def retranslateUi(self, SupervisionWindow):
        ...
        self.groupBox_2.setTitle(_translate("SupervisionWindow", "Mag viewer"))
