...
class Ui_SupervisionWindow(object):
    ...
    def retranslateUi(self, SupervisionWindow):
        ...
        self.groupBox.setTitle(_translate("SupervisionWindow", "Logs"))
        self.tabwidget.setTabText(self.tabwidget.indexOf(self.tools_panel), _translate("SupervisionWindow", "Tools"))
