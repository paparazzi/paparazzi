...
void photogrammetry_calculator_update(void)
{
  ...
  photogrammetry_sidestep = 78.4;//94.1;//117.0;//78.4;//viewing_ratio_width * photogrammetry_height * (1.0f - photogrammetry_sidelap_f);
  photogrammetry_triggerstep = 29.8;//23.8;//29.8;//viewing_ratio_height * photogrammetry_height * (1.0f - photogrammetry_overlap_f);
}
