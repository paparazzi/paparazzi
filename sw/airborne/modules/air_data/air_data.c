...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, DL_BARO_RAW, send_baro_raw);
  register_periodic_telemetry(DefaultPeriodic, DL_AIR_DATA, send_air_data);
  register_periodic_telemetry(DefaultPeriodic, DL_AMSL, send_amsl);
#endif
}
