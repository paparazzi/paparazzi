...
void imu_mpu9250_init(void)
{
  ...
  imu_set_defaults_gyro(IMU_MPU9250_ID, NULL, NULL, MPU9250_GYRO_SENS_FRAC[IMU_MPU9250_GYRO_RANGE], &MPU9250_GYRO_SENS_F[IMU_MPU9250_GYRO_RANGE]);
  imu_set_defaults_accel(IMU_MPU9250_ID, NULL, NULL, MPU9250_ACCEL_SENS_FRAC[IMU_MPU9250_ACCEL_RANGE], &MPU9250_ACCEL_SENS_F[IMU_MPU9250_ACCEL_RANGE]);
