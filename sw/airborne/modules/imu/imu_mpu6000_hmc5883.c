...
void imu_mpu_hmc_init(void)
{
  ...
  imu_set_defaults_gyro(IMU_MPU6000_HMC_ID, NULL, NULL, MPU60X0_GYRO_SENS_FRAC[IMU_MPU_GYRO_RANGE], &MPU60X0_GYRO_SENS_F[IMU_MPU_GYRO_RANGE]);
  imu_set_defaults_accel(IMU_MPU6000_HMC_ID, NULL, NULL, MPU60X0_ACCEL_SENS_FRAC[IMU_MPU_ACCEL_RANGE], &MPU60X0_ACCEL_SENS_F[IMU_MPU_ACCEL_RANGE]);
