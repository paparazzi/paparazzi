...
void imu_bmi088_init(void)
{
  ...
  imu_set_defaults_gyro(IMU_BMI088_ID, NULL, NULL, BMI088_GYRO_SENS_FRAC[IMU_BMI088_GYRO_RANGE], &BMI088_GYRO_SENS_F[IMU_BMI088_GYRO_RANGE]);
  imu_set_defaults_accel(IMU_BMI088_ID, NULL, NULL, BMI088_ACCEL_SENS_FRAC[IMU_BMI088_ACCEL_RANGE], &BMI088_ACCEL_SENS_F[IMU_BMI088_ACCEL_RANGE]);
}
