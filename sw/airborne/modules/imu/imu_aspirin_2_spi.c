...
void imu_aspirin2_init(void)
{
  ...
  imu_set_defaults_gyro(IMU_ASPIRIN2_ID, NULL, NULL, MPU60X0_GYRO_SENS_FRAC[ASPIRIN_2_GYRO_RANGE], &MPU60X0_GYRO_SENS_F[ASPIRIN_2_GYRO_RANGE]);
  imu_set_defaults_accel(IMU_ASPIRIN2_ID, NULL, NULL, MPU60X0_ACCEL_SENS_FRAC[ASPIRIN_2_ACCEL_RANGE], &MPU60X0_ACCEL_SENS_F[ASPIRIN_2_ACCEL_RANGE]);
