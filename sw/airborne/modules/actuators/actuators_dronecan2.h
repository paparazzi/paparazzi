...
#define ActuatorsDronecan2Commit()  RunOnceEvery(ACTUATORS_DRONECAN_RAW_DIV,actuators_dronecan_commit(&dronecan2, actuators_dronecan2_values, SERVOS_DRONECAN2_NB))
#endif
