...
/// new measurement every 3rd execution of baro_bmp_periodic
...
#define BaroBmpUpdate(_b) { if (baro_bmp.data_available) { _b = baro_bmp.pressure; baro_bmp.data_available = FALSE; } }
