...
/**
 * @file "modules/optical_flow_competition/optical_flow_avoider.c"
 * @author
 * This module is was used for group 7 in the 2022 MAV competition
 */

#include "modules/computer_vision/opticflow/inter_thread_data.h"
#include "modules/optical_flow_competition/optical_flow_avoider.h"
 ...
 */
void optical_flow_avoider_init(void)
{
 ...
 */
void optical_flow_avoider_periodic(void)
{
    ...
    float moveDistance = fminf(maxDistance, 0.2f * 10);
