...
#else
#define PERIODIC_SEND_H_CTL_A(_trans, _dev) DOWNLINK_SEND_H_CTL_A(_trans, _dev, &h_ctl_roll_integrator, &h_ctl_roll_setpoint, &h_ctl_pitch_integrator, &h_ctl_pitch_setpoint)
#endif
