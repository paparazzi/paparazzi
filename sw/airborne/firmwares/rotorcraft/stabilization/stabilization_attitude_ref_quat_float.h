...
#define ROLL_DEADBAND_EXCEEDED()						\
  (radio_control.values[RADIO_CONTROL_ROLL] >  STABILIZATION_ATTITUDE_FLOAT_DEADBAND_A || \
   radio_control.values[RADIO_CONTROL_ROLL] < -STABILIZATION_ATTITUDE_FLOAT_DEADBAND_A)
#define PITCH_DEADBAND_EXCEEDED()						\
  (radio_control.values[RADIO_CONTROL_PITCH] >  STABILIZATION_ATTITUDE_FLOAT_DEADBAND_E || \
   radio_control.values[RADIO_CONTROL_PITCH] < -STABILIZATION_ATTITUDE_FLOAT_DEADBAND_E)
