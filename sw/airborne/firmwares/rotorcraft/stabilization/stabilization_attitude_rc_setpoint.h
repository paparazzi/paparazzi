...
extern void stabilization_attitude_read_rc_setpoint_eulers_f(struct FloatEulers *sp, bool_t in_flight, bool_t in_carefree);
extern void stabilization_attitude_read_rc_forward_setpoint_eulers(struct Int32Eulers *sp, bool_t in_flight, bool_t in_carefree);
extern void stabilization_attitude_read_rc_forward_setpoint_eulers_f(struct FloatEulers *sp, bool_t in_flight, bool_t in_carefree);
...
extern void stabilization_attitude_read_rc_setpoint_quat_earth_bound_f(struct FloatQuat* q_sp, bool_t in_flight, bool_t in_carefree);
extern void stabilization_attitude_read_rc_forward_setpoint_quat_f(struct FloatQuat* q_sp, bool_t in_flight, bool_t in_carefree);
extern void stabilization_attitude_read_rc_forward_setpoint_quat_earth_bound_f(struct FloatQuat* q_sp, bool_t in_flight, bool_t in_carefree);
