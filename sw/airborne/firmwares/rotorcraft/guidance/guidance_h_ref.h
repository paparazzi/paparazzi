...
/** fixedpoint representation: Q37.26 will give a range of
 * 1.3e8 km and a resolution of 1.5e-8 m. At a rate of 500Hz,
 * a ref speed of 7.5e-6 m/s could still update the position.
 * /
