...
void control_run(void) {
  ...
  controller.cmd_thrust_ff = controller.one_over_J*controller.elevation_ddot_ref;
  controller.cmd_thrust_fb = -controller.one_over_J*(2*controller.xi_cl*controller.omega_cl*err_elevation_dot) -
