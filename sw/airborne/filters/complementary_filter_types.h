 ...
 */
static inline void update_first_order_complementary_vect3(struct FirstOrderComplementaryVect3 *filter,
 ...
 */
static inline void update_first_order_complementary_rates(struct FirstOrderComplementaryVect3 *filter,
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void update_butterworth_2_complementary_vect3(struct Butterworth2ComplementaryVect3 *filter,
    const struct FloatVect3 *value_x, const struct FloatVect3 *value_y)
{
 ...
 * @param[in] value_y Pointer to FloatVect3 input vector y values.
 */
static inline void update_butterworth_2_complementary_rates(struct Butterworth2ComplementaryVect3 *filter,
    const struct FloatRates *value_x, const struct FloatRates *value_y)
{
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void update_butterworth_4_complementary_vect3(struct Butterworth4ComplementaryVect3 *filter,
    const struct FloatVect3 *value_x, const struct FloatVect3 *value_y)
{
 ...
 * @param[in] value_y Pointer to FloatRates input p, q, r values.
 */
static inline void update_butterworth_4_complementary_rates(struct Butterworth4ComplementaryVect3 *filter,
    const struct FloatRates *value_x, const struct FloatRates *value_y)
{
