...
#include "subsystems/gps/gps_multi/gps_multi_ubx.h"
...
void gps_ubx_read_message(void)
{
  ...
  if (gps_ubx.msg_class == UBX_NAV_ID) {
    if (gps_ubx.msg_id == UBX_NAV_SOL_ID) {
      ...
      LLA_FLOAT_OF_BFP(lla_f, gps_ubx_state.lla_pos);
      struct UtmCoor_f utm_f;
      utm_f.zone = nav_utm_zone0;
      /* convert to utm */
      utm_of_lla_f(&utm_f, &lla_f);
      /* copy results of utm conversion */
      gps_ubx_state.utm_pos.east = utm_f.east * 100;
      gps_ubx_state.utm_pos.north = utm_f.north * 100;
      gps_ubx_state.utm_pos.alt = gps_ubx_state.lla_pos.alt;
      gps_ubx_state.utm_pos.zone = nav_utm_zone0;
#else
      ...
      gps_ubx_state.lla_pos.alt = gps_ubx_state.utm_pos.alt; // FIXME: with UTM only you do not receive ellipsoid altitude
