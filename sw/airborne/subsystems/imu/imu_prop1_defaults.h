...
/**
 * @file subsystems/imu/imu_prop1_defaults.h
 * Default sensitivity definitions for IMU Prop1
 */


#ifndef IMU_PROP1_DEFAULTS_H
#define IMU_PROP1_DEFAULTS_H
