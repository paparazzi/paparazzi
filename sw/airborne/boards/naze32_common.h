...
/* PPM
 *
 * Default: PPM_CONFIG 2: servos 1-6, input on PA7: RC I/O unused pin 8/id "6"
 *          PPM_CONFIG 1: servos 3-6, input on PA0: RC I/O rx_ppm pin 3/id "1"
 */
 ...
 *
 * silk       default   PPM_CONFIG=1 (PPM_PIN=PA0)
 *
 * '1'  PA8   servo1    -
 * '2'  PA11  servo2    -
 * '3'  PB6   servo3    servo3
