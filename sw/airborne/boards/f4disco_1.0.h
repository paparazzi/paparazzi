#ifndef CONFIG_F4DISCO_1_0_H
#define CONFIG_F4DISCO_1_0_H

#define BOARD_F4DISCO

/* F4DISCO has a 8MHz external clock and 168MHz internal. */
...
#define LED_1_GPIO_CLK RCC_AHB1ENR_IOPDEN
...
#define LED_2_GPIO_CLK RCC_AHB1ENR_IOPDEN
