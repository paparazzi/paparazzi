 ...
 * Board identifier.
 */
#define BOARD_PIXHAWK_6X
#define BOARD_NAME                  "Pixhawk 6X"
...
#define	PG06                           6U
#define	PG07_SPI_SLAVE6_SELECT         7U
...
#define	PH05_SPI_SLAVE2_SELECT         5U
#define	PH06                           6U
...
#define	LINE_SPI_SLAVE6_SELECT         PAL_LINE(GPIOG, 7U)
...
#define	LINE_LED5                      PAL_LINE(GPIOG, 15U)
...
#define	LINE_SPI_SLAVE2_SELECT         PAL_LINE(GPIOH, 5U)
...
#define	LINE_SPI_SLAVE5_SELECT         PAL_LINE(GPIOH, 15U)
...
#define	LINE_SPI_SLAVE3_SELECT         PAL_LINE(GPIOI, 4U)
#define	LINE_PWM_INPUT1                PAL_LINE(GPIOI, 5U)
#define	LINE_SPI3_DRDY1                PAL_LINE(GPIOI, 6U)
#define	LINE_SPI3_DRDY2                PAL_LINE(GPIOI, 7U)
#define	LINE_SPI_SLAVE4_SELECT         PAL_LINE(GPIOI, 8U)
#define	LINE_SPI_SLAVE1_SELECT         PAL_LINE(GPIOI, 9U)
#define	LINE_SPI_SLAVE7_SELECT         PAL_LINE(GPIOI, 10U)
...
#define VAL_GPIOF_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PF00_I2C2_SDA) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PF09_ALARM) | \
...
#define VAL_GPIOG_MODER                 (PIN_MODE_INPUT(PG00_HW_VER_REV_DRIVE) | \
					 ...
					 PIN_MODE_INPUT(PG06) | \
					 PIN_MODE_INPUT(PG07_SPI_SLAVE6_SELECT) | \
...
#define VAL_GPIOG_OTYPER                (PIN_OTYPE_OPENDRAIN(PG00_HW_VER_REV_DRIVE) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PG07_SPI_SLAVE6_SELECT) | \
...
#define VAL_GPIOG_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PG00_HW_VER_REV_DRIVE) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PG07_SPI_SLAVE6_SELECT) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PG15_LED5))
...
#define VAL_GPIOG_PUPDR                 (PIN_PUPDR_PULLDOWN(PG00_HW_VER_REV_DRIVE) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PG07_SPI_SLAVE6_SELECT) | \
...
#define VAL_GPIOG_ODR                   (PIN_ODR_LEVEL_HIGH(PG00_HW_VER_REV_DRIVE) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PG07_SPI_SLAVE6_SELECT) | \
...
#define VAL_GPIOG_AFRL			(PIN_AFIO_AF(PG00_HW_VER_REV_DRIVE, 0) | \
					 ...
					 PIN_AFIO_AF(PG06, 0) | \
					 PIN_AFIO_AF(PG07_SPI_SLAVE6_SELECT, 0))
...
#define VAL_GPIOH_MODER                 (PIN_MODE_ALTERNATE(PH00_OSC_IN) | \
					 ...
					 PIN_MODE_INPUT(PH05_SPI_SLAVE2_SELECT) | \
					 PIN_MODE_INPUT(PH06) | \
					 ...
					 PIN_MODE_INPUT(PH15_SPI_SLAVE5_SELECT))
...
#define VAL_GPIOH_OTYPER                (PIN_OTYPE_PUSHPULL(PH00_OSC_IN) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PH05_SPI_SLAVE2_SELECT) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PH15_SPI_SLAVE5_SELECT))
...
#define VAL_GPIOH_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PH00_OSC_IN) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PH05_SPI_SLAVE2_SELECT) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PH15_SPI_SLAVE5_SELECT))
...
#define VAL_GPIOH_PUPDR                 (PIN_PUPDR_FLOATING(PH00_OSC_IN) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PH05_SPI_SLAVE2_SELECT) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PH15_SPI_SLAVE5_SELECT))
...
#define VAL_GPIOH_ODR                   (PIN_ODR_LEVEL_HIGH(PH00_OSC_IN) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PH05_SPI_SLAVE2_SELECT) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PH15_SPI_SLAVE5_SELECT))
...
#define VAL_GPIOH_AFRL			(PIN_AFIO_AF(PH00_OSC_IN, 0) | \
					 ...
					 PIN_AFIO_AF(PH05_SPI_SLAVE2_SELECT, 0) | \
					 PIN_AFIO_AF(PH06, 0) | \
...
#define VAL_GPIOH_AFRH			(PIN_AFIO_AF(PH08_I2C3_SDA, 4) | \
					 ...
					 PIN_AFIO_AF(PH15_SPI_SLAVE5_SELECT, 0))
...
#define VAL_GPIOI_MODER                 (PIN_MODE_ALTERNATE(PI00_SERVO1) | \
					 ...
					 PIN_MODE_INPUT(PI04_SPI_SLAVE3_SELECT) | \
					 PIN_MODE_ALTERNATE(PI05_PWM_INPUT1) | \
					 PIN_MODE_INPUT(PI06_SPI3_DRDY1) | \
					 PIN_MODE_INPUT(PI07_SPI3_DRDY2) | \
					 PIN_MODE_INPUT(PI08_SPI_SLAVE4_SELECT) | \
					 PIN_MODE_INPUT(PI09_SPI_SLAVE1_SELECT) | \
					 PIN_MODE_INPUT(PI10_SPI_SLAVE7_SELECT) | \
...
#define VAL_GPIOI_OTYPER                (PIN_OTYPE_PUSHPULL(PI00_SERVO1) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PI04_SPI_SLAVE3_SELECT) | \
					 PIN_OTYPE_PUSHPULL(PI05_PWM_INPUT1) | \
					 PIN_OTYPE_OPENDRAIN(PI06_SPI3_DRDY1) | \
					 PIN_OTYPE_OPENDRAIN(PI07_SPI3_DRDY2) | \
					 PIN_OTYPE_OPENDRAIN(PI08_SPI_SLAVE4_SELECT) | \
					 PIN_OTYPE_OPENDRAIN(PI09_SPI_SLAVE1_SELECT) | \
					 PIN_OTYPE_OPENDRAIN(PI10_SPI_SLAVE7_SELECT) | \
...
#define VAL_GPIOI_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PI00_SERVO1) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PI04_SPI_SLAVE3_SELECT) | \
					 PIN_OSPEED_SPEED_HIGH(PI05_PWM_INPUT1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PI06_SPI3_DRDY1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PI07_SPI3_DRDY2) | \
					 PIN_OSPEED_SPEED_VERYLOW(PI08_SPI_SLAVE4_SELECT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PI09_SPI_SLAVE1_SELECT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PI10_SPI_SLAVE7_SELECT) | \
...
#define VAL_GPIOI_PUPDR                 (PIN_PUPDR_FLOATING(PI00_SERVO1) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PI04_SPI_SLAVE3_SELECT) | \
					 PIN_PUPDR_FLOATING(PI05_PWM_INPUT1) | \
					 PIN_PUPDR_PULLDOWN(PI06_SPI3_DRDY1) | \
					 PIN_PUPDR_PULLDOWN(PI07_SPI3_DRDY2) | \
					 PIN_PUPDR_PULLDOWN(PI08_SPI_SLAVE4_SELECT) | \
					 PIN_PUPDR_PULLDOWN(PI09_SPI_SLAVE1_SELECT) | \
					 PIN_PUPDR_PULLDOWN(PI10_SPI_SLAVE7_SELECT) | \
...
#define VAL_GPIOI_ODR                   (PIN_ODR_LEVEL_LOW(PI00_SERVO1) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PI04_SPI_SLAVE3_SELECT) | \
					 PIN_ODR_LEVEL_HIGH(PI05_PWM_INPUT1) | \
					 PIN_ODR_LEVEL_HIGH(PI06_SPI3_DRDY1) | \
					 PIN_ODR_LEVEL_HIGH(PI07_SPI3_DRDY2) | \
					 PIN_ODR_LEVEL_HIGH(PI08_SPI_SLAVE4_SELECT) | \
					 PIN_ODR_LEVEL_HIGH(PI09_SPI_SLAVE1_SELECT) | \
					 PIN_ODR_LEVEL_HIGH(PI10_SPI_SLAVE7_SELECT) | \
...
#define VAL_GPIOI_AFRL			(PIN_AFIO_AF(PI00_SERVO1, 2) | \
					 ...
					 PIN_AFIO_AF(PI04_SPI_SLAVE3_SELECT, 0) | \
					 PIN_AFIO_AF(PI05_PWM_INPUT1, 3) | \
					 PIN_AFIO_AF(PI06_SPI3_DRDY1, 0) | \
					 PIN_AFIO_AF(PI07_SPI3_DRDY2, 0))

#define VAL_GPIOI_AFRH			(PIN_AFIO_AF(PI08_SPI_SLAVE4_SELECT, 0) | \
					 PIN_AFIO_AF(PI09_SPI_SLAVE1_SELECT, 0) | \
					 PIN_AFIO_AF(PI10_SPI_SLAVE7_SELECT, 0) | \
...
#define ENERGY_SAVE_LOWS_SIZE 	 2
...
#define ENERGY_SAVE_INPUTS \
	...
	LINE_SERVO2, \
	LINE_SERVO1
#define ENERGY_SAVE_INPUTS_SIZE 	 11
