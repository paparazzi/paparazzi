...
#define POWER_SWITCH_PORT 1
#define POWER_SWITCH_PIN 17

#define CAM_SWITCH_PORT 1
#define CAM_SWITCH_PIN 18

#define GPS_RESET_PORT 1
#define GPS_RESET_PIN 19

#define Configure_GPS_RESET_Pin() gpio_setup_output(GPS_RESET_PORT, GPS_RESET_PIN)
#define Set_GPS_RESET_Pin_LOW() gpio_clear(GPS_RESET_PORT, GPS_RESET_PIN)
#define Open_GPS_RESET_Pin() gpio_setup_input(GPS_RESET_PORT, GPS_RESET_PIN)
