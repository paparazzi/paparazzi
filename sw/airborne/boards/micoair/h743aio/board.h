...
#define	LINE_SPI_SLAVE0                PAL_LINE(GPIOA, 15U)

#define	LINE_M6                        PAL_LINE(GPIOB, 0U)
#define	LINE_M5                        PAL_LINE(GPIOB, 1U)
...
#define	LINE_SPI_SLAVE2                PAL_LINE(GPIOD, 4U)
#define	LINE_SPI_SLAVE1                PAL_LINE(GPIOD, 5U)
#define	LINE_UART3_TX                  PAL_LINE(GPIOD, 8U)
#define	LINE_UART3_RX                  PAL_LINE(GPIOD, 9U)
#define	LINE_M7                        PAL_LINE(GPIOD, 12U)
#define	LINE_M8                        PAL_LINE(GPIOD, 13U)
#define	LINE_LED_STRIP                 PAL_LINE(GPIOD, 14U)
#define	LINE_BEEPER                    PAL_LINE(GPIOD, 15U)

#define	LINE_UART8_RX                  PAL_LINE(GPIOE, 0U)
#define	LINE_UART8_TX                  PAL_LINE(GPIOE, 1U)
#define	LINE_LED1                      PAL_LINE(GPIOE, 4U)
#define	LINE_LED2                      PAL_LINE(GPIOE, 5U)
#define	LINE_LED3                      PAL_LINE(GPIOE, 6U)
#define	LINE_UART7_RX                  PAL_LINE(GPIOE, 7U)
#define	LINE_M4                        PAL_LINE(GPIOE, 9U)
#define	LINE_M3                        PAL_LINE(GPIOE, 11U)
#define	LINE_M2                        PAL_LINE(GPIOE, 13U)
#define	LINE_M1                        PAL_LINE(GPIOE, 14U)
...
#define VAL_GPIOB_MODER                 (PIN_MODE_ALTERNATE(M6) | \
					 PIN_MODE_ALTERNATE(M5) | \
					 PIN_MODE_INPUT(PB02) | \
					 PIN_MODE_INPUT(PB03) | \
					 PIN_MODE_INPUT(PB04) | \
					 PIN_MODE_INPUT(PB05) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(M6) | \
					 PIN_OTYPE_PUSHPULL(M5) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(M6) | \
					 PIN_OSPEED_SPEED_HIGH(M5) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLUP(M6) | \
					 PIN_PUPDR_PULLUP(M5) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(M6) | \
					 PIN_ODR_LEVEL_LOW(M5) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(M6, 2) | \
					 PIN_AFIO_AF(M5, 2) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03, 0) | \
					 PIN_AFIO_AF(PB04, 0) | \
...
#define VAL_GPIOC_MODER                 (PIN_MODE_ANALOG(ADC1) | \
...
#define VAL_GPIOC_OTYPER                (PIN_OTYPE_PUSHPULL(ADC1) | \
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(ADC1) | \
...
#define VAL_GPIOC_PUPDR                 (PIN_PUPDR_FLOATING(ADC1) | \
...
#define VAL_GPIOC_ODR                   (PIN_ODR_LEVEL_LOW(ADC1) | \
...
#define VAL_GPIOC_AFRL			(PIN_AFIO_AF(ADC1, 0) | \
					 PIN_AFIO_AF(ADC6, 0) | \
					 PIN_AFIO_AF(SPI2_MISO, 5) | \
					 PIN_AFIO_AF(SPI2_MOSI, 5) | \
					 PIN_AFIO_AF(PC04, 0) | \
					 PIN_AFIO_AF(PC05, 0) | \
					 PIN_AFIO_AF(UART6_TX, 7) | \
					 PIN_AFIO_AF(UART6_RX, 7))
...
#define VAL_GPIOD_MODER                 (PIN_MODE_INPUT(PD00) | \
					 ...
					 PIN_MODE_INPUT(PD10) | \
					 PIN_MODE_INPUT(PD11) | \
					 PIN_MODE_ALTERNATE(M7) | \
					 PIN_MODE_ALTERNATE(M8) | \
					 PIN_MODE_ALTERNATE(LED_STRIP) | \
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(M7) | \
					 PIN_OTYPE_PUSHPULL(M8) | \
					 PIN_OTYPE_PUSHPULL(LED_STRIP) | \
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PD00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(M7) | \
					 PIN_OSPEED_SPEED_HIGH(M8) | \
					 PIN_OSPEED_SPEED_HIGH(LED_STRIP) | \
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_PULLDOWN(PD00) | \
					 ...
					 PIN_PUPDR_PULLUP(M7) | \
					 PIN_PUPDR_PULLUP(M8) | \
					 PIN_PUPDR_PULLUP(LED_STRIP) | \
					 PIN_PUPDR_PULLUP(BEEPER))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_LOW(PD00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(M7) | \
					 PIN_ODR_LEVEL_LOW(M8) | \
					 PIN_ODR_LEVEL_LOW(LED_STRIP) | \
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(UART3_TX, 7) | \
					 ...
					 PIN_AFIO_AF(M7, 2) | \
					 PIN_AFIO_AF(M8, 2) | \
					 PIN_AFIO_AF(LED_STRIP, 2) | \
					 PIN_AFIO_AF(BEEPER, 2))
...
#define VAL_GPIOE_MODER                 (PIN_MODE_ALTERNATE(UART8_RX) | \
					 ...
					 PIN_MODE_INPUT(PE08) | \
					 PIN_MODE_ALTERNATE(M4) | \
					 PIN_MODE_INPUT(PE10) | \
					 PIN_MODE_ALTERNATE(M3) | \
					 PIN_MODE_INPUT(PE12) | \
					 PIN_MODE_ALTERNATE(M2) | \
					 PIN_MODE_ALTERNATE(M1) | \
					 PIN_MODE_INPUT(PE15))
...
#define VAL_GPIOE_OTYPER                (PIN_OTYPE_PUSHPULL(UART8_RX) | \
					 ...
					 PIN_OTYPE_PUSHPULL(M4) | \
					 PIN_OTYPE_PUSHPULL(PE10) | \
					 PIN_OTYPE_PUSHPULL(M3) | \
					 PIN_OTYPE_PUSHPULL(PE12) | \
					 PIN_OTYPE_PUSHPULL(M2) | \
					 PIN_OTYPE_PUSHPULL(M1) | \
...
#define VAL_GPIOE_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(UART8_RX) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(M4) | \
					 PIN_OSPEED_SPEED_VERYLOW(PE10) | \
					 PIN_OSPEED_SPEED_HIGH(M3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PE12) | \
					 PIN_OSPEED_SPEED_HIGH(M2) | \
					 PIN_OSPEED_SPEED_HIGH(M1) | \
...
#define VAL_GPIOE_ODR                   (PIN_ODR_LEVEL_HIGH(UART8_RX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(M4) | \
					 PIN_ODR_LEVEL_LOW(PE10) | \
					 PIN_ODR_LEVEL_LOW(M3) | \
					 PIN_ODR_LEVEL_LOW(PE12) | \
					 PIN_ODR_LEVEL_LOW(M2) | \
					 PIN_ODR_LEVEL_LOW(M1) | \
...
#define AF_M6                            2U
#define AF_LINE_M6                       2U
#define AF_M5                            2U
#define AF_LINE_M5                       2U
...
#define AF_UART6_TX                      7U
#define AF_LINE_UART6_TX                 7U
#define AF_UART6_RX                      7U
...
#define AF_M7                            2U
#define AF_LINE_M7                       2U
#define AF_M8                            2U
#define AF_LINE_M8                       2U
#define AF_LED_STRIP                     2U
#define AF_LINE_LED_STRIP                2U
#define AF_BEEPER                        2U
#define AF_LINE_BEEPER                   2U
#define AF_UART8_RX                      8U
#define AF_LINE_UART8_RX                 8U
#define AF_UART8_TX                      8U
#define AF_LINE_UART8_TX                 8U
#define AF_UART7_RX                      7U
#define AF_LINE_UART7_RX                 7U
#define AF_M4                            1U
#define AF_LINE_M4                       1U
#define AF_M3                            1U
#define AF_LINE_M3                       1U
#define AF_M2                            1U
#define AF_LINE_M2                       1U
#define AF_M1                            1U
#define AF_LINE_M1                       1U
#define AF_OSC_IN                        0U
...
#define M8_TIM_CH	 2
#define M8_TIM_AF	 2
#define LED_STRIP_TIM	 4
#define LED_STRIP_TIM_FN	 CH
#define LED_STRIP_TIM_CH	 3
#define LED_STRIP_TIM_AF	 2
#define BEEPER_TIM	 4
#define BEEPER_TIM_FN	 CH
#define BEEPER_TIM_CH	 4
#define BEEPER_TIM_AF	 2
