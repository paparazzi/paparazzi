...
void imu_apogee_init(void)
{
  ...
  imu_set_defaults_gyro(IMU_BOARD_ID, NULL, NULL, MPU60X0_GYRO_SENS_FRAC[APOGEE_GYRO_RANGE], &MPU60X0_GYRO_SENS_F[APOGEE_GYRO_RANGE]);
  imu_set_defaults_accel(IMU_BOARD_ID, NULL, NULL, MPU60X0_ACCEL_SENS_FRAC[APOGEE_ACCEL_RANGE], &MPU60X0_ACCEL_SENS_F[APOGEE_ACCEL_RANGE]);
