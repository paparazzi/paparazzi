...
#endif
#if USE_PWM0
#define USE_PWM_SERVO0 1
#define SERVO0 0
#define SERVO0_GPIO         PAL_PORT(LINE_SERVO0)
#define SERVO0_PIN          PAL_PAD(LINE_SERVO0)
#define SERVO0_AF           AF_LINE_SERVO0
#define SERVO0_PWM_DRIVER   CONCAT_BOARD_PARAM(PWMD, SERVO0_TIM)
#define SERVO0_CHANNEL      (SERVO0_TIM_CH-1)
#define SERVO0_PWM_CONF     CONCAT_BOARD_PARAM(pwmcfg, SERVO0_TIM)
#endif
...
#if (USE_PWM1 && USE_ICU_SERVO8)
#error "PW1 and PWM_INPUT2 are not compatible"
#endif
#if USE_ICU_SERVO8
#define USE_ICU_TIM5        1
#define SERVO8 8
#define SERVO8_GPIO         GPIOA
#define SERVO8_PIN          GPIO2
#define SERVO8_AF           GPIO_AF2
#define SERVO8_ICU_DRIVER   ICUD5
#define SERVO8_CHANNEL      ICU_CHANNEL_4
#endif
...
#define	PA02_SERVO1                    2U
#define	PA03_UART2_RX                  3U
#define	PA04_ADC1_IN4                  4U
#define	PA05_SPI1_SCK                  5U
#define	PA06_SPI1_MISO                 6U
#define	PA07_SPI1_MOSI                 7U
#define	PA08_SERVO7                    8U
#define	PA09_OTG_FS_VBUS               9U
#define	PA10_USART1_RX                 10U
#define	PA11_OTG_FS_DM                 11U
#define	PA12_OTG_FS_DP                 12U
#define	PA13_SWDIO                     13U
#define	PA14_SWCLK                     14U
#define	PA15_SERVO5                    15U

#define	PB00_SERVO0                    0U
#define	PB01_SERVO6                    1U
#define	PB02_BOOT1                     2U
#define	PB03_SERVO4                    3U
#define	PB04_SERVO3                    4U
#define	PB05_SERVO2                    5U
#define	PB06_USART1_TX                 6U
#define	PB07_I2C1_SDA                  7U
#define	PB08_I2C1_SCL                  8U
#define	PB09_SPI1_CS                   9U
#define	PB10_I2C2_SCL                  10U
#define	PB11_I2C2_SDA                  11U
#define	PB12_POWER_SWITCH              12U
#define	PB13_RX2_POL                   13U
#define	PB14_SDIO_DETECT               14U
#define	PB15_AUX4                      15U
...
#define	LINE_SERVO7                    PAL_LINE(GPIOA, 8U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_UART4_TX) | \
					 ...
					 PIN_MODE_ALTERNATE(PA02_SERVO1) | \
					 PIN_MODE_ALTERNATE(PA03_UART2_RX) | \
					 PIN_MODE_ANALOG(PA04_ADC1_IN4) | \
					 PIN_MODE_ALTERNATE(PA05_SPI1_SCK) | \
					 PIN_MODE_ALTERNATE(PA06_SPI1_MISO) | \
					 PIN_MODE_ALTERNATE(PA07_SPI1_MOSI) | \
					 PIN_MODE_ALTERNATE(PA08_SERVO7) | \
					 PIN_MODE_INPUT(PA09_OTG_FS_VBUS) | \
					 PIN_MODE_ALTERNATE(PA10_USART1_RX) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_UART4_TX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA15_SERVO5))

#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_UART4_TX, 8) | \
					 PIN_AFIO_AF(PA01_UART4_RX, 8) | \
					 PIN_AFIO_AF(PA02_SERVO1, 1) | \
					 PIN_AFIO_AF(PA03_UART2_RX, 7) | \
					 PIN_AFIO_AF(PA04_ADC1_IN4, 0) | \
					 PIN_AFIO_AF(PA05_SPI1_SCK, 5) | \
					 PIN_AFIO_AF(PA06_SPI1_MISO, 5) | \
					 PIN_AFIO_AF(PA07_SPI1_MOSI, 5))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_SERVO7, 1) | \
					 PIN_AFIO_AF(PA09_OTG_FS_VBUS, 0) | \
					 PIN_AFIO_AF(PA10_USART1_RX, 7) | \
					 PIN_AFIO_AF(PA11_OTG_FS_DM, 10) | \
					 PIN_AFIO_AF(PA12_OTG_FS_DP, 10) | \
					 PIN_AFIO_AF(PA13_SWDIO, 0) | \
					 PIN_AFIO_AF(PA14_SWCLK, 0) | \
					 PIN_AFIO_AF(PA15_SERVO5, 1))

#define VAL_GPIOB_MODER                 (PIN_MODE_ALTERNATE(PB00_SERVO0) | \
					 PIN_MODE_ALTERNATE(PB01_SERVO6) | \
					 PIN_MODE_INPUT(PB02_BOOT1) | \
					 PIN_MODE_ALTERNATE(PB03_SERVO4) | \
					 PIN_MODE_ALTERNATE(PB04_SERVO3) | \
					 PIN_MODE_ALTERNATE(PB05_SERVO2) | \
					 PIN_MODE_ALTERNATE(PB06_USART1_TX) | \
					 PIN_MODE_ALTERNATE(PB07_I2C1_SDA) | \
					 PIN_MODE_ALTERNATE(PB08_I2C1_SCL) | \
					 PIN_MODE_OUTPUT(PB09_SPI1_CS) | \
					 PIN_MODE_ALTERNATE(PB10_I2C2_SCL) | \
					 PIN_MODE_ALTERNATE(PB11_I2C2_SDA) | \
					 PIN_MODE_OUTPUT(PB12_POWER_SWITCH) | \
					 PIN_MODE_OUTPUT(PB13_RX2_POL) | \
					 PIN_MODE_INPUT(PB14_SDIO_DETECT) | \
					 PIN_MODE_INPUT(PB15_AUX4))

#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_SERVO0) | \
					 PIN_OTYPE_PUSHPULL(PB01_SERVO6) | \
					 PIN_OTYPE_OPENDRAIN(PB02_BOOT1) | \
					 PIN_OTYPE_PUSHPULL(PB03_SERVO4) | \
					 PIN_OTYPE_PUSHPULL(PB04_SERVO3) | \
					 PIN_OTYPE_PUSHPULL(PB05_SERVO2) | \
					 PIN_OTYPE_PUSHPULL(PB06_USART1_TX) | \
					 PIN_OTYPE_OPENDRAIN(PB07_I2C1_SDA) | \
					 PIN_OTYPE_OPENDRAIN(PB08_I2C1_SCL) | \
					 PIN_OTYPE_PUSHPULL(PB09_SPI1_CS) | \
					 PIN_OTYPE_OPENDRAIN(PB10_I2C2_SCL) | \
					 PIN_OTYPE_OPENDRAIN(PB11_I2C2_SDA) | \
					 PIN_OTYPE_PUSHPULL(PB12_POWER_SWITCH) | \
					 PIN_OTYPE_PUSHPULL(PB13_RX2_POL) | \
					 PIN_OTYPE_OPENDRAIN(PB14_SDIO_DETECT) | \
					 PIN_OTYPE_OPENDRAIN(PB15_AUX4))

#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PB00_SERVO0) | \
					 PIN_OSPEED_SPEED_HIGH(PB01_SERVO6) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02_BOOT1) | \
					 PIN_OSPEED_SPEED_HIGH(PB03_SERVO4) | \
					 PIN_OSPEED_SPEED_HIGH(PB04_SERVO3) | \
					 PIN_OSPEED_SPEED_HIGH(PB05_SERVO2) | \
					 PIN_OSPEED_SPEED_HIGH(PB06_USART1_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_I2C1_SDA) | \
					 PIN_OSPEED_SPEED_HIGH(PB08_I2C1_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PB09_SPI1_CS) | \
					 PIN_OSPEED_SPEED_HIGH(PB10_I2C2_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PB11_I2C2_SDA) | \
					 PIN_OSPEED_SPEED_HIGH(PB12_POWER_SWITCH) | \
					 PIN_OSPEED_SPEED_HIGH(PB13_RX2_POL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB14_SDIO_DETECT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB15_AUX4))

#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_SERVO0) | \
					 PIN_PUPDR_FLOATING(PB01_SERVO6) | \
					 PIN_PUPDR_FLOATING(PB02_BOOT1) | \
					 PIN_PUPDR_FLOATING(PB03_SERVO4) | \
					 PIN_PUPDR_FLOATING(PB04_SERVO3) | \
					 PIN_PUPDR_FLOATING(PB05_SERVO2) | \
					 PIN_PUPDR_FLOATING(PB06_USART1_TX) | \
					 PIN_PUPDR_PULLUP(PB07_I2C1_SDA) | \
					 PIN_PUPDR_PULLUP(PB08_I2C1_SCL) | \
					 PIN_PUPDR_FLOATING(PB09_SPI1_CS) | \
					 PIN_PUPDR_PULLUP(PB10_I2C2_SCL) | \
					 PIN_PUPDR_PULLUP(PB11_I2C2_SDA) | \
					 PIN_PUPDR_FLOATING(PB12_POWER_SWITCH) | \
					 PIN_PUPDR_FLOATING(PB13_RX2_POL) | \
					 PIN_PUPDR_PULLUP(PB14_SDIO_DETECT) | \
					 PIN_PUPDR_FLOATING(PB15_AUX4))

#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_SERVO0) | \
					 PIN_ODR_LEVEL_LOW(PB01_SERVO6) | \
					 PIN_ODR_LEVEL_LOW(PB02_BOOT1) | \
					 PIN_ODR_LEVEL_LOW(PB03_SERVO4) | \
					 PIN_ODR_LEVEL_LOW(PB04_SERVO3) | \
					 PIN_ODR_LEVEL_LOW(PB05_SERVO2) | \
					 PIN_ODR_LEVEL_HIGH(PB06_USART1_TX) | \
					 PIN_ODR_LEVEL_HIGH(PB07_I2C1_SDA) | \
					 PIN_ODR_LEVEL_HIGH(PB08_I2C1_SCL) | \
					 PIN_ODR_LEVEL_HIGH(PB09_SPI1_CS) | \
					 PIN_ODR_LEVEL_HIGH(PB10_I2C2_SCL) | \
					 PIN_ODR_LEVEL_HIGH(PB11_I2C2_SDA) | \
					 PIN_ODR_LEVEL_HIGH(PB12_POWER_SWITCH) | \
					 PIN_ODR_LEVEL_HIGH(PB13_RX2_POL) | \
					 PIN_ODR_LEVEL_LOW(PB14_SDIO_DETECT) | \
					 PIN_ODR_LEVEL_LOW(PB15_AUX4))

#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_SERVO0, 2) | \
					 PIN_AFIO_AF(PB01_SERVO6, 2) | \
					 PIN_AFIO_AF(PB02_BOOT1, 0) | \
					 PIN_AFIO_AF(PB03_SERVO4, 1) | \
					 PIN_AFIO_AF(PB04_SERVO3, 2) | \
					 PIN_AFIO_AF(PB05_SERVO2, 2) | \
					 PIN_AFIO_AF(PB06_USART1_TX, 7) | \
					 PIN_AFIO_AF(PB07_I2C1_SDA, 4))

#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08_I2C1_SCL, 4) | \
					 PIN_AFIO_AF(PB09_SPI1_CS, 0) | \
					 PIN_AFIO_AF(PB10_I2C2_SCL, 4) | \
					 PIN_AFIO_AF(PB11_I2C2_SDA, 4) | \
					 PIN_AFIO_AF(PB12_POWER_SWITCH, 0) | \
					 PIN_AFIO_AF(PB13_RX2_POL, 0) | \
					 PIN_AFIO_AF(PB14_SDIO_DETECT, 0) | \
					 PIN_AFIO_AF(PB15_AUX4, 0))

#define VAL_GPIOC_MODER                 (PIN_MODE_OUTPUT(PC00_LED1) | \
					 PIN_MODE_OUTPUT(PC01_LED3) | \
					 PIN_MODE_INPUT(PC02) | \
					 PIN_MODE_OUTPUT(PC03_LED4) | \
					 PIN_MODE_INPUT(PC04_AUX3) | \
					 PIN_MODE_INPUT(PC05_AUX2) | \
					 PIN_MODE_ALTERNATE(PC06_USART6_TX) | \
					 PIN_MODE_ALTERNATE(PC07_USART6_RX) | \
					 ...
					 PIN_MODE_OUTPUT(PC13_LED2) | \
					 PIN_MODE_ALTERNATE(PC14_OSC32_IN) | \
					 PIN_MODE_ALTERNATE(PC15_OSC32_OUT))

#define VAL_GPIOC_OTYPER                (PIN_OTYPE_PUSHPULL(PC00_LED1) | \
					 PIN_OTYPE_PUSHPULL(PC01_LED3) | \
					 PIN_OTYPE_PUSHPULL(PC02) | \
					 PIN_OTYPE_PUSHPULL(PC03_LED4) | \
					 PIN_OTYPE_OPENDRAIN(PC04_AUX3) | \
					 PIN_OTYPE_OPENDRAIN(PC05_AUX2) | \
					 PIN_OTYPE_PUSHPULL(PC06_USART6_TX) | \
					 PIN_OTYPE_PUSHPULL(PC07_USART6_RX) | \
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PC00_LED1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC01_LED3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC02) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC03_LED4) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC04_AUX3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PC05_AUX2) | \
					 PIN_OSPEED_SPEED_HIGH(PC06_USART6_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PC07_USART6_RX) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PC13_LED2) | \
...
#define VAL_GPIOC_PUPDR                 (PIN_PUPDR_FLOATING(PC00_LED1) | \
					 PIN_PUPDR_FLOATING(PC01_LED3) | \
					 PIN_PUPDR_PULLDOWN(PC02) | \
					 PIN_PUPDR_FLOATING(PC03_LED4) | \
					 PIN_PUPDR_FLOATING(PC04_AUX3) | \
					 PIN_PUPDR_FLOATING(PC05_AUX2) | \
					 PIN_PUPDR_FLOATING(PC06_USART6_TX) | \
					 PIN_PUPDR_FLOATING(PC07_USART6_RX) | \
					 ...
					 PIN_PUPDR_FLOATING(PC13_LED2) | \
					 PIN_PUPDR_FLOATING(PC14_OSC32_IN) | \
					 PIN_PUPDR_FLOATING(PC15_OSC32_OUT))

#define VAL_GPIOC_ODR                   (PIN_ODR_LEVEL_LOW(PC00_LED1) | \
					 PIN_ODR_LEVEL_LOW(PC01_LED3) | \
					 PIN_ODR_LEVEL_LOW(PC02) | \
					 PIN_ODR_LEVEL_LOW(PC03_LED4) | \
					 PIN_ODR_LEVEL_LOW(PC04_AUX3) | \
					 PIN_ODR_LEVEL_LOW(PC05_AUX2) | \
					 PIN_ODR_LEVEL_HIGH(PC06_USART6_TX) | \
					 PIN_ODR_LEVEL_HIGH(PC07_USART6_RX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PC13_LED2) | \
					 PIN_ODR_LEVEL_HIGH(PC14_OSC32_IN) | \
					 PIN_ODR_LEVEL_HIGH(PC15_OSC32_OUT))

#define VAL_GPIOC_AFRL			(PIN_AFIO_AF(PC00_LED1, 0) | \
					 PIN_AFIO_AF(PC01_LED3, 0) | \
					 PIN_AFIO_AF(PC02, 0) | \
					 PIN_AFIO_AF(PC03_LED4, 0) | \
					 PIN_AFIO_AF(PC04_AUX3, 0) | \
					 PIN_AFIO_AF(PC05_AUX2, 0) | \
					 PIN_AFIO_AF(PC06_USART6_TX, 8) | \
					 PIN_AFIO_AF(PC07_USART6_RX, 8))
...
#define AF_PA08_SERVO7                   1U
#define AF_LINE_SERVO7                   1U
#define AF_PA10_USART1_RX                7U
...
#define AF_PA15_SERVO5                   1U
#define AF_LINE_SERVO5                   1U
#define AF_PB00_SERVO0                   2U
#define AF_LINE_SERVO0                   2U
#define AF_PB01_SERVO6                   2U
#define AF_LINE_SERVO6                   2U
#define AF_PB03_SERVO4                   1U
#define AF_LINE_SERVO4                   1U
#define AF_PB04_SERVO3                   2U
...
#define AF_PC06_USART6_TX                8U
#define AF_LINE_USART6_TX                8U
#define AF_PC07_USART6_RX                8U
...
#define ENERGY_SAVE_INPUT \
	...
	LINE_AUX2, \
	LINE_LED2
#define ENERGY_SAVE_INPUT_SIZE 	 16
