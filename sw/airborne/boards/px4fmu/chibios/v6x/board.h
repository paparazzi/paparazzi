...
#define	LINE_LED6                      PAL_LINE(GPIOF, 9U)
...
#define VAL_GPIOF_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PF00_I2C2_SDA) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PF09_LED6) | \
...
#define ENERGY_SAVE_INPUTS \
	...
	LINE_SPI_SLAVE1, \
	LINE_SPI_SLAVE7
#define ENERGY_SAVE_INPUTS_SIZE 	 19
