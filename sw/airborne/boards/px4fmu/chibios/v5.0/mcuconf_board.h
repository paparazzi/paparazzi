...
#endif
#if (SERVO1_TIM == 9 && USE_ICU_SERVO1) || \
    (SERVO2_TIM == 9 && USE_ICU_SERVO2) || \
    (SERVO3_TIM == 9 && USE_ICU_SERVO3) || \
    (SERVO4_TIM == 9 && USE_ICU_SERVO4) || \
    (SERVO5_TIM == 9 && USE_ICU_SERVO5) || \
    (SERVO6_TIM == 9 && USE_ICU_SERVO6) || \
    (SERVO7_TIM == 9 && USE_ICU_SERVO7) || \
    (SERVO8_TIM == 9 && USE_ICU_SERVO8) || \
    (SERVO9_TIM == 9 && USE_ICU_SERVO9) || \
    (SERVO10_TIM == 9 && USE_ICU_SERVO10) || \
    (SERVO11_TIM == 9 && USE_ICU_SERVO11) || \
    (SERVO12_TIM == 9 && USE_ICU_SERVO12) || \
    (SERVO13_TIM == 9 && USE_ICU_SERVO13) || \
    (SERVO14_TIM == 9 && USE_ICU_SERVO14) || \
    (SERVO15_TIM == 9 && USE_ICU_SERVO15) || \
    (SERVO16_TIM == 9 && USE_ICU_SERVO16)
#define USE_ICU_TIM9                        TRUE
#elif (SERVO1_TIM == 9 && USE_PWM_SERVO1) || \
    (SERVO2_TIM == 9 && USE_PWM_SERVO2) || \
    (SERVO3_TIM == 9 && USE_PWM_SERVO3) || \
    (SERVO4_TIM == 9 && USE_PWM_SERVO4) || \
    (SERVO5_TIM == 9 && USE_PWM_SERVO5) || \
    (SERVO6_TIM == 9 && USE_PWM_SERVO6) || \
    (SERVO7_TIM == 9 && USE_PWM_SERVO7) || \
    (SERVO8_TIM == 9 && USE_PWM_SERVO8) || \
    (SERVO9_TIM == 9 && USE_PWM_SERVO9) || \
    (SERVO10_TIM == 9 && USE_PWM_SERVO10) || \
    (SERVO11_TIM == 9 && USE_PWM_SERVO11) || \
    (SERVO12_TIM == 9 && USE_PWM_SERVO12) || \
    (SERVO13_TIM == 9 && USE_PWM_SERVO13) || \
    (SERVO14_TIM == 9 && USE_PWM_SERVO14) || \
    (SERVO15_TIM == 9 && USE_PWM_SERVO15) || \
    (SERVO16_TIM == 9 && USE_PWM_SERVO16)
#define USE_PWM_TIM9                        TRUE
#endif
