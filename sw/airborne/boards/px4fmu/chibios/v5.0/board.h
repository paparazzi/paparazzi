...
#define	LINE_SERVO9                    PAL_LINE(GPIOI, 5U)
...
#define VAL_GPIOI_MODER                 (PIN_MODE_OUTPUT(PI00_ARMED) | \
					 ...
					 PIN_MODE_ALTERNATE(PI05_SERVO9) | \
...
#define VAL_GPIOI_OTYPER                (PIN_OTYPE_PUSHPULL(PI00_ARMED) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PI05_SERVO9) | \
...
#define VAL_GPIOI_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PI00_ARMED) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PI05_SERVO9) | \
...
#define VAL_GPIOI_PUPDR                 (PIN_PUPDR_FLOATING(PI00_ARMED) | \
					 ...
					 PIN_PUPDR_FLOATING(PI05_SERVO9) | \
...
#define VAL_GPIOI_ODR                   (PIN_ODR_LEVEL_LOW(PI00_ARMED) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PI05_SERVO9) | \
...
#define AF_PI05_SERVO9                   3U
#define AF_LINE_SERVO9                   3U
...
#define ENERGY_SAVE_INPUTS \
	...
	LINE_SPI_SLAVE12, \
	LINE_SPI_SLAVE13
#define ENERGY_SAVE_INPUTS_SIZE 	 30
