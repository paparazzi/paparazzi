...
#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(LED1) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(LED1) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(LED1) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(LED1) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(LED1) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(LED1, 0) | \
...
#define VAL_GPIOC_OTYPER                (PIN_OTYPE_PUSHPULL(VBAT_MEAS) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(USER_BUTTON) | \
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(VBAT_MEAS) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(USER_BUTTON) | \
...
#define VAL_GPIOC_PUPDR                 (PIN_PUPDR_FLOATING(VBAT_MEAS) | \
					 ...
					 PIN_PUPDR_PULLDOWN(USER_BUTTON) | \
