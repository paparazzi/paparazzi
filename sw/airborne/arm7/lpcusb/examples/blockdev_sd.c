...
char tohex(unsigned char inbyte, int nibble)
{
    unsigned char in;
    ...
    if (in > 15) return 'F';
    if (in > 9)  return in+'A'-10;
    return in+'0';
}

/* ****************************************************************************
 read CID and put into serial number
 */
int getCID(void)
{
	U8 cardresp, i;
    ...
    abCID[0] = tohex(iob[0],0);
    abCID[1] = tohex(iob[0],1);
    ...
    abCID[7] = tohex(iob[8],0);
    abCID[8] = tohex(iob[8],1);
    
    /* Product serial number 55:24 */
    abCID[9]  = tohex(iob[9],0);
    abCID[10] = tohex(iob[9],1);
    abCID[11] = tohex(iob[10],0);
    abCID[12] = tohex(iob[10],1);
    abCID[13] = tohex(iob[11],0);
    abCID[14] = tohex(iob[11],1);
    abCID[15] = tohex(iob[12],0);
    abCID[16] = tohex(iob[12],1);
