...
static void invensense2_fix_config(struct invensense2_t *inv) {
  ...
  imu_set_defaults_gyro(inv->abi_id, NULL, NULL, invensense2_gyro_scale[inv->gyro_range], &invensense2_gyro_scale_f[inv->gyro_range]);
  imu_set_defaults_accel(inv->abi_id, NULL, NULL, invensense2_accel_scale[inv->accel_range], &invensense2_accel_scale_f[inv->accel_range]);
}
